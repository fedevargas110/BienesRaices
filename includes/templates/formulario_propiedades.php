<fieldset>
                ...
                <input type="text" id="titulo" name="propiedad[titulo]" placeholder="Nombre de la Propiedad" value="<?php echo s($propiedad->titulo) ?>">
            ...
            <fieldset>
                ...
                <select name="propiedad[vendedor]" id="vendedores">
